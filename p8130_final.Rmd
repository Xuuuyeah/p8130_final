...
tidy_aft_model_output <- tidy(aft_model_output, conf.int = TRUE)

# Add exponentiated coefficients for time ratios
tidy_aft_model_output <- tidy_aft_model_output %>%
  mutate(
...
aft_model_no_outlier <- survreg(aft_formula, data = data_clean_no_outliers, dist = "weibull")

# Summary of the new model
summary(aft_model_no_outlier)
